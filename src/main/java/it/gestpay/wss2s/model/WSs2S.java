 ...
 * 
 */
@WebServiceClient(name = "WSs2s", targetNamespace = "https://ecomms2s.sella.it/", wsdlLocation = "https://sandbox.gestpay.net/gestpay/gestpayws/WSs2s.asmx?WSDL")
public class WSs2S
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://sandbox.gestpay.net/gestpay/gestpayws/WSs2s.asmx?WSDL");
